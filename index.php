...
<html>
	<head>
        ...
        <meta name="author" content="naugustinovic">
		<!-- favicon meta -->
...
<body>
	...
	<footer>
		<p>Copyright &copy; ' . date("Y") . ' Nikola Augustinović. <a href="https://github.com/"><img src="img/git.png" title="Github" alt="Github"></a></p>
	</footer>
</body>
</html>';
?>
